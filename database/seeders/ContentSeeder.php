...
class ContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $glossaries = [
            ['term' => 'Aktivitas air', 'definition' => 'Banyaknya air dalam makanan yang memengaruhi cepat rusak atau tidak.'],
            ['term' => 'Amilopektin', 'definition' => 'Zat dalam ketan yang membuatnya lengket.'],
            ['term' => 'Aroma', 'definition' => 'Bau khas dari suatu bahan.'],
            ['term' => 'Asam amino', 'definition' => 'Bagian kecil penyusun protein.'],
            ['term' => 'Bahan fermentasi', 'definition' => 'Bahan yang diolah melalui proses fermentasi.'],
            ['term' => 'Batik', 'definition' => 'Kain bergambar yang dibuat dengan cara khusus menggunakan lilin dan pewarna.'],
            ['term' => 'Beras ketan', 'definition' => 'Beras yang lengket saat dimasak.'],
            ['term' => 'Berpikir kritis', 'definition' => 'Cara berpikir teliti untuk memahami dan menilai suatu hal.'],
            ['term' => 'Budaya lokal', 'definition' => 'Kebiasaan dan tradisi yang berasal dari daerah setempat.'],
            ['term' => 'Canting', 'definition' => 'Alat kecil untuk menorehkan lilin pada kain batik.'],
            ['term' => 'Cair', 'definition' => 'Bentuk benda yang dapat mengalir seperti air.'],
            ['term' => 'Dampak lingkungan', 'definition' => 'Pengaruh kegiatan manusia terhadap alam.'],
            ['term' => 'Ekologi', 'definition' => 'Ilmu tentang hubungan makhluk hidup dengan lingkungannya.'],
            ['term' => 'Ekosistem', 'definition' => 'Kesatuan makhluk hidup dan lingkungannya.'],
            ['term' => 'Ekosistem laut', 'definition' => 'Lingkungan hidup makhluk di laut.'],
            ['term' => 'Energi panas', 'definition' => 'Panas yang berasal dari matahari atau api.'],
            ['term' => 'Etnosains', 'definition' => 'Cara mempelajari sains melalui budaya dan kebiasaan masyarakat.'],
            ['term' => 'Eksplorasi', 'definition' => 'Kegiatan mencari dan mencoba pengetahuan baru.'],
            ['term' => 'Fermentasi', 'definition' => 'Proses perubahan bahan dengan bantuan mikroorganisme.'],
            ['term' => 'Filter feeder', 'definition' => 'Hewan yang makan dengan menyaring makanan dari air.'],
            ['term' => 'Gelatinisasi', 'definition' => 'Proses mengembangnya pati saat dipanaskan.'],
            ['term' => 'Granula pati', 'definition' => 'Butiran kecil pati dalam beras.'],
            ['term' => 'Gula pereduksi', 'definition' => 'Jenis gula yang mudah bereaksi saat dipanaskan.'],
            ['term' => 'Habitat', 'definition' => 'Tempat tinggal alami makhluk hidup.'],
            ['term' => 'Higienis', 'definition' => 'Bersih dan aman dari kuman.'],
            ['term' => 'Identitas budaya', 'definition' => 'Ciri khas suatu daerah yang membedakannya dari daerah lain.'],
            ['term' => 'Interaktif', 'definition' => 'Bersifat saling berhubungan dan melibatkan pengguna secara aktif.'],
            ['term' => 'IPAS', 'definition' => 'Mata pelajaran yang mempelajari alam dan kehidupan sosial.'],
            ['term' => 'Kadar air', 'definition' => 'Banyaknya air yang terdapat dalam suatu bahan.'],
            ['term' => 'Kaldu', 'definition' => 'Air rebusan ikan atau daging yang berasa gurih.'],
            ['term' => 'Kearifan lokal', 'definition' => 'Pengetahuan dan kebiasaan baik yang diwariskan oleh masyarakat.'],
            ['term' => 'Keberlanjutan', 'definition' => 'Keadaan yang tetap terjaga untuk masa depan.'],
            ['term' => 'Kelestarian', 'definition' => 'Keadaan alam dan budaya tetap terjaga.'],
            ['term' => 'Kerang bambu', 'definition' => 'Kerang panjang yang hidup di dalam pasir pantai.'],
            ['term' => 'Keseimbangan lingkungan', 'definition' => 'Keadaan alam yang terjaga agar tetap sehat.'],
            ['term' => 'Konsentrasi larutan', 'definition' => 'Tingkat kepekatan suatu larutan.'],
            ['term' => 'Konsistensi', 'definition' => 'Tingkat kekentalan suatu bahan.'],
            ['term' => 'Larutan', 'definition' => 'Campuran zat yang menyatu dengan air.'],
            ['term' => 'Lilin malam (lilin batik)', 'definition' => 'Lilin panas untuk menutup bagian kain saat membatik.'],
            ['term' => 'Lorjuk', 'definition' => 'Kerang bambu kecil yang hidup di pasir pantai.'],
            ['term' => 'Maillard', 'definition' => 'Proses perubahan warna dan aroma pada makanan saat dipanaskan.'],
            ['term' => 'Malam (lilin batik)', 'definition' => 'Lilin panas untuk menutup bagian kain saat membatik.'],
            ['term' => 'Mencanting', 'definition' => 'Kegiatan menggambar motif batik dengan canting.'],
            ['term' => 'Melanoidin', 'definition' => 'Zat pemberi warna cokelat pada makanan goreng.'],
            ['term' => 'Mikroorganisme', 'definition' => 'Makhluk hidup sangat kecil yang tidak terlihat mata.'],
            ['term' => 'Mineral', 'definition' => 'Zat penting untuk kesehatan tulang dan darah.'],
            ['term' => 'Mordan', 'definition' => 'Zat untuk membantu warna menempel kuat pada kain.'],
            ['term' => 'Motif', 'definition' => 'Pola atau gambar hias pada kain batik.'],
            ['term' => 'Nutrisi', 'definition' => 'Zat gizi yang dibutuhkan tubuh untuk tumbuh sehat.'],
            ['term' => 'Observasi', 'definition' => 'Kegiatan mengamati dengan teliti.'],
            ['term' => 'Omega-3', 'definition' => 'Lemak baik untuk kesehatan jantung.'],
            ['term' => 'Padat', 'definition' => 'Bentuk benda yang keras dan tidak mengalir.'],
            ['term' => 'Panas matahari', 'definition' => 'Energi panas dari sinar matahari.'],
            ['term' => 'Pekat', 'definition' => 'Keadaan cairan yang sangat kental.'],
            ['term' => 'Pelestarian', 'definition' => 'Usaha menjaga agar alam dan budaya tetap terawat.'],
            ['term' => 'Pelorodan', 'definition' => 'Proses menghilangkan lilin dari kain batik dengan air panas.'],
            ['term' => 'Pemanasan', 'definition' => 'Proses memberi panas pada bahan.'],
            ['term' => 'Pemanfaatan bijak', 'definition' => 'Menggunakan alam secara hemat dan tidak berlebihan.'],
            ['term' => 'Pengawetan alami', 'definition' => 'Cara menjaga makanan agar awet tanpa bahan kimia.'],
            ['term' => 'Pengeringan', 'definition' => 'Proses mengurangi air dengan dijemur.'],
            ['term' => 'Penggorengan', 'definition' => 'Proses memasak dengan minyak panas.'],
            ['term' => 'Penguapan', 'definition' => 'Perubahan air menjadi uap karena panas.'],
            ['term' => 'Penguapan air', 'definition' => 'Perubahan air menjadi uap karena panas matahari.'],
            ['term' => 'Penangkapan berkelanjutan', 'definition' => 'Cara menangkap ikan tanpa merusak alam.'],
            ['term' => 'Penjemuran', 'definition' => 'Mengeringkan bahan di bawah sinar matahari.'],
            ['term' => 'Perubahan fisika', 'definition' => 'Perubahan bentuk tanpa mengubah jenis zat.'],
            ['term' => 'Perubahan sifat bahan', 'definition' => 'Perubahan bentuk, warna, atau rasa bahan.'],
            ['term' => 'Perubahan tekstur', 'definition' => 'Perubahan rasa permukaan bahan.'],
            ['term' => 'Perubahan wujud zat', 'definition' => 'Perubahan bentuk benda, misalnya padat menjadi cair.'],
            ['term' => 'Petis', 'definition' => 'Bumbu kental dari olahan ikan atau udang.'],
            ['term' => 'Pewarna alami', 'definition' => 'Pewarna yang berasal dari tumbuhan atau bahan alam.'],
            ['term' => 'Pewarna kimia', 'definition' => 'Pewarna buatan dari bahan kimia.'],
            ['term' => 'Pewarnaan', 'definition' => 'Proses memberi warna pada kain.'],
            ['term' => 'Protein', 'definition' => 'Zat gizi untuk pertumbuhan dan perbaikan tubuh.'],
            ['term' => 'Reaksi biologis', 'definition' => 'Perubahan bahan karena kerja makhluk hidup kecil.'],
            ['term' => 'Reaksi kimia', 'definition' => 'Perubahan zat karena proses pemanasan atau pencampuran.'],
            ['term' => 'Reaksi Maillard', 'definition' => 'Perubahan warna dan aroma saat makanan digoreng.'],
            ['term' => 'Rengginang', 'definition' => 'Makanan ringan dari beras ketan yang digoreng.'],
            ['term' => 'Reversibel', 'definition' => 'Perubahan yang dapat kembali seperti semula.'],
            ['term' => 'Sifat benda', 'definition' => 'Ciri khas suatu benda, seperti keras atau lunak.'],
            ['term' => 'Sikap ilmiah', 'definition' => 'Sikap teliti, jujur, dan ingin tahu dalam belajar.'],
            ['term' => 'Siklus hidup', 'definition' => 'Tahapan kehidupan makhluk hidup dari kecil sampai dewasa.'],
            ['term' => 'Sumber daya alam', 'definition' => 'Segala sesuatu dari alam yang dapat dimanfaatkan manusia.'],
            ['term' => 'Suhu mencair', 'definition' => 'Suhu saat benda padat berubah menjadi cair.'],
            ['term' => 'Tekstur', 'definition' => 'Rasa permukaan benda saat disentuh.'],
            ['term' => 'Terasi', 'definition' => 'Bumbu dari udang kecil yang difermentasi.'],
            ['term' => 'Tanggung jawab', 'definition' => 'Sikap mau menjaga dan melakukan tugas dengan baik.'],
            ['term' => 'Udang rebon', 'definition' => 'Udang kecil sebagai bahan utama terasi.'],
            ['term' => 'Warisan budaya', 'definition' => 'Budaya yang diwariskan dari generasi ke generasi.'],
        ];
